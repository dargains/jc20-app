...
const ImageOverlay = ({src, alt, showImage, handleClose, className}) => {
  return (
    <aside className={cx("text-white w-screen full-h fixed top-0 left-0 right-0 bottom-0 flex flex-col items-center justify-center transition-opacity opacity-0 duration-200 pointer-events-none z-30", {"opacity-100 pointer-events-auto": showImage}, className)}>
