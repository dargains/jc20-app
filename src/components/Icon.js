...
const Complex = ({ type }) => {
  const icon = (() => {
    switch (type) {
      case 'Sofa':
        return <Interna height={36}/>
      case 'Art':
        return <Image height={36}/>
      case 'Building':
        return <Construction height={36}/>
      case 'Drinks':
        return <Drink height={36}/>
      case 'RC':
        return <RC height={36}/>
      case 'Contact':
        return <Contato height={36}/>
      default:
        return <p>nada</p>
    }
  })(type)
...
const Menu = props => {
  return (
    <SVGBase name="menu" {...props}>
      <g xmlns="http://www.w3.org/2000/svg" transform="translate(-647 -243)">
        <path fill="none" d="M0 0H24V24H0z" transform="translate(647 243)"/>
...
const Share = props => {
  return (
    <SVGBase name="share" {...props} >
      <g xmlns="http://www.w3.org/2000/svg" id="Group_355" transform="translate(-695 -243)">
        <path id="Rectangle_235" fill="none" d="M0 0H24V24H0z" transform="translate(695 243)"/>
        <g id="compartilhar" transform="translate(698 245)">
          <path id="Path_884" d="M320.085 18.708A2.708 2.708 0 1 1 317.376 16a2.708 2.708 0 0 1 2.709 2.708zm0 0" transform="translate(-302.376 -15.375)"/>
          <path id="Path_885" d="M302 6.667a3.333 3.333 0 1 1 3.333-3.333A3.337 3.337 0 0 1 302 6.667zm0-5.417a2.083 2.083 0 1 0 2.083 2.083A2.086 2.086 0 0 0 302 1.25zm0 0" transform="translate(-287.001)"/>
          <path id="Path_886" d="M320.085 360.041a2.708 2.708 0 1 1-2.708-2.708 2.708 2.708 0 0 1 2.708 2.708zm0 0" transform="translate(-302.376 -343.374)"/>
          <path id="Path_887" d="M302 348a3.333 3.333 0 1 1 3.333-3.333A3.337 3.337 0 0 1 302 348zm0-5.417a2.083 2.083 0 1 0 2.083 2.083 2.086 2.086 0 0 0-2.083-2.084zm0 0" transform="translate(-287.001 -327.999)"/>
          <path id="Path_888" d="M21.417 189.376a2.708 2.708 0 1 1-2.708-2.708 2.708 2.708 0 0 1 2.708 2.708zm0 0" transform="translate(-15.375 -179.376)"/>
          <path id="Path_889" d="M3.333 177.335A3.333 3.333 0 1 1 6.667 174a3.337 3.337 0 0 1-3.333 3.333zm0-5.417A2.083 2.083 0 1 0 5.417 174a2.086 2.086 0 0 0-2.083-2.083zm0 0" transform="translate(0 -164.001)"/>
          <path id="Path_890" d="M115.183 96.291a.833.833 0 0 1-.413-1.558l7.732-4.408a.833.833 0 1 1 .825 1.448l-7.733 4.408a.828.828 0 0 1-.412.109zm0 0" transform="translate(-109.882 -86.69)"/>
          <path id="Path_891" d="M122.936 272.294a.828.828 0 0 1-.412-.109l-7.733-4.408a.833.833 0 0 1 .825-1.448l7.733 4.408a.833.833 0 0 1-.413 1.558zm0 0" transform="translate(-109.904 -255.819)"/>
        </g>
      </g>
    </SVGBase>
  )
  ...
  return (
    <SVGBase name="eye" {...props}>
      <g transform="translate(-639 -330)">
        <path fill="none" d="M0 0H24V24H0z" transform="translate(639 330)"/>
  ...
  return (
    <SVGBase name="image" {...props}>
      <g transform="translate(-101 -243)">
        <path fill="none" d="M0 0H24V24H0z" transform="translate(101 243)"/>
...
const Contato = props => {
  return (
    <SVGBase name="contato" {...props}>
      <g transform="translate(-245 -243)">
        <path fill="none" d="M0 0H24V24H0z" transform="translate(245 243)"/>
  ...
  return (
    <SVGBase name="area" {...props}>
      <g transform="translate(-843 -243)">
        <path  d="M0 0H24V24H0z" fill="none" transform="translate(843 243)"/>
        <g transform="translate(793 -465)">
            <g transform="translate(52 710)" strokeWidth="1.2px" stroke="currentColor" fill="none">
...
const Suite = props => {
  return (
    <SVGBase name="suite" viewbox="0 0 48 24" {...props}>
      <g xmlns="http://www.w3.org/2000/svg" id="Group_353" transform="translate(-581 -243)">
        <path id="Rectangle_255" fill="none" d="M0 0H44V24H0z" transform="translate(581 243)"/>
        <g id="bed_3_" transform="translate(583 248.81)">
            <g id="Group_255">
                <path id="Path_1166" d="M15.75 65.67v-3.146a1.7 1.7 0 0 0-1.736-1.924H3.378a1.694 1.694 0 0 0-1.735 1.924v3.146A1.91 1.91 0 0 0 0 67.822v2.442a.708.708 0 0 0 .672.745H.9v1.924a.708.708 0 0 0 .672.745H2.2a.708.708 0 0 0 .672-.745v-1.945h11.7v1.945a.708.708 0 0 0 .672.745h.634a.708.708 0 0 0 .672-.745v-1.945h.224a.708.708 0 0 0 .672-.745v-2.421a1.985 1.985 0 0 0-1.696-2.152zM2.277 62.524h.037c0-.973.578-1.179 1.064-1.179h10.636c.485 0 1.064.207 1.064 1.179v3.125h-.5v-1.78a.708.708 0 0 0-.672-.745H9.8a.708.708 0 0 0-.672.745v1.78h-.786v-1.78a.708.708 0 0 0-.672-.745H3.564a.708.708 0 0 0-.672.745v1.78h-.615zM13.9 63.869v1.78H9.8v-1.78zm-6.2 0v1.78H3.6v-1.78zm-5.517 9.064h-.634v-1.945h.634zm13.66 0h-.634v-1.945h.634zm.877-2.669H.653v-1.1H16.72zm0-1.842H.653v-.6c0-1.242.821-1.428 1.288-1.428h13.492c.485 0 1.288.186 1.288 1.428v.6z" transform="translate(0 -60.6)"/>
            </g>
        </g>
        <g id="bathroom" transform="translate(607 246.888)">
            <g id="Group_244">
                <g id="Group_243">
                    <path id="Path_1160" d="M.533 8.582V1.867A1.869 1.869 0 0 1 2.4 0h1.536a1.332 1.332 0 0 1 1.153.667l.594 1.027a1.587 1.587 0 0 1 1.435.795.267.267 0 0 1-.1.365L4.712 4.187a.267.267 0 0 1-.133.036.28.28 0 0 1-.069-.009.267.267 0 0 1-.162-.125 1.6 1.6 0 0 1-.024-1.549l-.464-.807a.268.268 0 0 0-.231-.133H2.4a.267.267 0 0 0-.267.267v6.666H15.2a.8.8 0 0 1 .267 1.551v.316a4.538 4.538 0 0 1-4 4.5v.3a.8.8 0 0 1-1.6 0v-.267H6.133v.267a.8.8 0 0 1-1.6 0v-.3a4.538 4.538 0 0 1-4-4.5v-.315a.759.759 0 0 1-.3-.185A.783.783 0 0 1 0 9.333a.8.8 0 0 1 .533-.751zm4.173-5.009l1.788-1.032a1.061 1.061 0 0 0-.919-.306 1.038 1.038 0 0 0-.566.272 1.106 1.106 0 0 0-.157.183 1.067 1.067 0 0 0-.146.883zM2.4 1.067h1.229a.8.8 0 0 1 .693.4l.357.619.022-.016a1.461 1.461 0 0 1 .432-.265L4.627.933a.8.8 0 0 0-.691-.4H2.4a1.335 1.335 0 0 0-1.333 1.334v6.666H1.6V1.867a.8.8 0 0 1 .8-.8zm8 14.133a.267.267 0 0 0 .533 0v-.267H10.4zm-5.333 0a.267.267 0 0 0 .533 0v-.267h-.533zm-4-4.8a4 4 0 0 0 4 4h5.867a4 4 0 0 0 4-4v-.267H1.067zm-.452-.877A.256.256 0 0 0 .8 9.6h14.4a.267.267 0 0 0 .267-.267.261.261 0 0 0-.082-.19.256.256 0 0 0-.185-.077H.8a.267.267 0 0 0-.267.267.261.261 0 0 0 .082.19z" />
                </g>
            </g>
            <g id="Group_246" transform="translate(5.867 3.714)">
                <g id="Group_245">
                    <path id="Path_1161" d="M272.105 111.459a.267.267 0 0 1 .364.1l.533.924a.267.267 0 1 1-.46.27l-.533-.924a.267.267 0 0 1 .096-.37z" transform="translate(-271.972 -111.423)"/>
                </g>
            </g>
            <g id="Group_248" transform="translate(6.791 3.182)">
                <g id="Group_247">
                    <path id="Path_1162" d="M244.422 95.5a.267.267 0 0 1 .362.1l.533.924a.267.267 0 1 1-.462.267l-.533-.924a.267.267 0 0 1 .1-.367z" transform="translate(-244.287 -95.469)"/>
                </g>
            </g>
            <g id="Group_250" transform="translate(4.944 4.249)">
                <g id="Group_249">
                    <path id="Path_1163" d="M299.846 127.5a.267.267 0 0 1 .362.1l.533.924a.267.267 0 0 1-.462.267l-.533-.924a.267.267 0 0 1 .1-.367z" transform="translate(-299.711 -127.469)"/>
                </g>
            </g>
            <g id="Group_252" transform="translate(6.338 5.597)">
                <g id="Group_251">
                    <path id="Path_1164" d="M257.989 167.951a.267.267 0 0 1 .364.1l.533.924a.267.267 0 1 1-.462.267l-.533-.924a.267.267 0 0 1 .098-.367z" transform="translate(-257.856 -167.916)"/>
                </g>
            </g>
            <g id="Group_254" transform="translate(7.405 5.064)">
                <g id="Group_253">
        ...
        <path id="Rectangle_267" d="M0 0H1V16H0z" transform="translate(603 247)"/>
    </g>
    </SVGBase>
  )
}
...
const Bathroom = props => {
  return (
    <SVGBase name="bathroom" {...props}>
      <g xmlns="http://www.w3.org/2000/svg" id="Group_351" transform="translate(-485 -243)">
        <path id="Rectangle_262" fill="none" d="M0 0H24V24H0z" transform="translate(485 243)"/>
        <g id="bathroom" transform="translate(487 245.561)">
            <g id="Group_244">
                <g id="Group_243">
                    <path id="Path_1160" d="M.651 10.483V2.28A2.283 2.283 0 0 1 2.931 0h1.877a1.627 1.627 0 0 1 1.408.814l.726 1.254a1.938 1.938 0 0 1 1.753.971.326.326 0 0 1-.118.445l-2.822 1.63a.326.326 0 0 1-.163.044.342.342 0 0 1-.085-.011.326.326 0 0 1-.2-.152A1.959 1.959 0 0 1 5.281 3.1l-.567-.985a.328.328 0 0 0-.282-.163h-1.5a.326.326 0 0 0-.326.326v8.143h15.96a.975.975 0 0 1 .326 1.894v.385a5.543 5.543 0 0 1-4.886 5.5v.367a.977.977 0 0 1-1.954 0v-.327H7.491v.326a.977.977 0 1 1-1.954 0V18.2a5.543 5.543 0 0 1-4.886-5.5v-.385a.927.927 0 0 1-.361-.225.957.957 0 0 1-.29-.69.977.977 0 0 1 .651-.917zm5.1-6.118L7.932 3.1a1.3 1.3 0 0 0-1.122-.371 1.268 1.268 0 0 0-.692.333 1.351 1.351 0 0 0-.192.223 1.3 1.3 0 0 0-.178 1.08zM2.931 1.3h1.5a.981.981 0 0 1 .847.489l.436.757c.008-.007.018-.012.027-.019a1.784 1.784 0 0 1 .528-.323l-.617-1.065a.974.974 0 0 0-.844-.488H2.931A1.631 1.631 0 0 0 1.3 2.28v8.143h.651V2.28a.977.977 0 0 1 .98-.98zM12.7 18.566a.326.326 0 0 0 .651 0v-.326H12.7zm-6.514 0a.326.326 0 0 0 .651 0v-.326h-.648zM1.3 12.7a4.891 4.891 0 0 0 4.886 4.886h7.166A4.891 4.891 0 0 0 18.24 12.7v-.326H1.3zm-.549-1.068a.312.312 0 0 0 .226.093h17.589a.326.326 0 0 0 .326-.326.318.318 0 0 0-.1-.232.312.312 0 0 0-.226-.093H.977a.326.326 0 0 0-.326.326.318.318 0 0 0 .1.232z"/>
                </g>
            </g>
            <g id="Group_246" transform="translate(7.166 4.536)">
                <g id="Group_245">
                    <path id="Path_1161" d="M272.135 111.467a.326.326 0 0 1 .445.119l.651 1.129a.326.326 0 1 1-.562.33l-.651-1.129a.326.326 0 0 1 .117-.449z" transform="translate(-271.972 -111.423)"/>
                </g>
            </g>
            <g id="Group_248" transform="translate(8.295 3.887)">
                <g id="Group_247">
                    <path id="Path_1162" d="M244.452 95.512a.326.326 0 0 1 .442.118l.651 1.129a.326.326 0 1 1-.564.326l-.651-1.129a.326.326 0 0 1 .122-.444z" transform="translate(-244.287 -95.469)"/>
                </g>
            </g>
            <g id="Group_250" transform="translate(6.038 5.19)">
                <g id="Group_249">
                    <path id="Path_1163" d="M299.876 127.512a.326.326 0 0 1 .442.118l.651 1.129a.326.326 0 0 1-.564.326l-.651-1.129a.326.326 0 0 1 .122-.444z" transform="translate(-299.711 -127.469)"/>
                </g>
            </g>
            <g id="Group_252" transform="translate(7.741 6.836)">
                <g id="Group_251">
                    <path id="Path_1164" d="M258.019 167.959a.326.326 0 0 1 .445.119l.651 1.128a.326.326 0 1 1-.564.326l-.651-1.132a.326.326 0 0 1 .119-.441z" transform="translate(-257.856 -167.916)"/>
                </g>
            </g>
            <g id="Group_254" transform="translate(9.044 6.185)">
                <g id="Group_253">
                    <path id="Path_1165" d="M226.018 151.959a.326.326 0 0 1 .445.119l.651 1.128a.326.326 0 0 1-.564.326l-.65-1.132a.326.326 0 0 1 .118-.441z" transform="translate(-225.855 -151.916)"/>
                </g>
            </g>
        </g>
    </g>
