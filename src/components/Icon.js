...
const Agent = props => {
  return (
    <SVGBase name="agent" {...props}>
      <g transform="translate(-288 -332)">
        <g transform="translate(280.475 334)">
          <g transform="translate(10.025)">
            <path d="M23.146,9.069h-.372a5.074,5.074,0,1,0-6.5,0H15.9a5.919,5.919,0,0,0-5.879,5.946V19.4a.594.594,0,0,0,.59.6h17.82a.594.594,0,0,0,.59-.6V15.015A5.919,5.919,0,0,0,23.146,9.069ZM15.632,5.132a3.894,3.894,0,1,1,3.893,3.938A3.92,3.92,0,0,1,15.632,5.132Zm5.176,5.132-1.282,1.3-1.282-1.3Zm-4.369,8.543H11.205V15.015a4.731,4.731,0,0,1,4.7-4.752h.67l2.262,2.288Zm1.266,0,1.821-4.751,1.821,4.751Zm10.141,0H22.612l-2.4-6.256,2.262-2.288h.67a4.731,4.731,0,0,1,4.7,4.752Z" transform="translate(-10.025)" />
          </g>
        </g>
      </g>
    </SVGBase>
...
const Document = props => {
  return (
    <SVGBase name="document" {...props}>
      <g transform="translate(-829 -332)">
        <g transform="translate(772.5 334)">
          <path d="M76.063,4.859,71.375.172A.587.587,0,0,0,70.961,0h-8.2A1.76,1.76,0,0,0,61,1.758V18.242A1.76,1.76,0,0,0,62.758,20H74.477a1.76,1.76,0,0,0,1.758-1.758V5.273A.591.591,0,0,0,76.063,4.859ZM71.547,2l2.687,2.687h-2.1a.587.587,0,0,1-.586-.586Zm2.93,16.828H62.758a.587.587,0,0,1-.586-.586V1.758a.587.587,0,0,1,.586-.586h7.617V4.1a1.76,1.76,0,0,0,1.758,1.758h2.93V18.242A.587.587,0,0,1,74.477,18.828Z" transform="translate(0 0)" />
          <path d="M158.617,212h-7.031a.586.586,0,0,0,0,1.172h7.031a.586.586,0,0,0,0-1.172Z" transform="translate(-86.484 -203.719)" />
          <path d="M158.617,272h-7.031a.586.586,0,0,0,0,1.172h7.031a.586.586,0,0,0,0-1.172Z" transform="translate(-86.484 -261.375)" />
          <path d="M158.617,332h-7.031a.586.586,0,0,0,0,1.172h7.031a.586.586,0,0,0,0-1.172Z" transform="translate(-86.484 -319.031)" />
          <path d="M156.273,392h-4.687a.586.586,0,0,0,0,1.172h4.688a.586.586,0,0,0,0-1.172Z" transform="translate(-86.484 -376.688)" />
        </g>
      </g>
    </SVGBase>
  )
...
const Family = props => {
  return (
    <SVGBase name="family" {...props}>
      <g transform="translate(-256 -332)">
        <g transform="translate(254.722 329.082)">
          <path d="M22.878,24.118h-.8v-11.7l.56.42a.4.4,0,1,0,.48-.64L13.518,5a.4.4,0,0,0-.48,0l-9.6,7.2a.4.4,0,1,0,.48.64l.56-.42v11.7h-.8a.4.4,0,0,0,0,.8h19.2a.4.4,0,0,0,0-.8Zm-12,0h-3.6l0-4a2.4,2.4,0,0,1,4.408-1.31A2.191,2.191,0,0,0,11.99,22.1,2.4,2.4,0,0,0,10.879,24.118Zm-3.2-9.2a2,2,0,1,1,2,2,2,2,0,0,1-2-2Zm4.2,5.4a1.4,1.4,0,1,1,1.4,1.4A1.4,1.4,0,0,1,11.879,20.318Zm-.2,3.8a1.6,1.6,0,0,1,3.2,0Zm7.6,0h-3.6A2.4,2.4,0,0,0,14.568,22.1a2.19,2.19,0,0,0,.75-2.6,2.4,2.4,0,0,1,3.96,1.821Zm-4.4-8a2,2,0,1,1,2,2,2,2,0,0,1-2-2Zm6.4,8h-1.2v-2.8a3.2,3.2,0,0,0-1.714-2.832,2.8,2.8,0,1,0-2.976,0,3.148,3.148,0,0,0-.506.333,2.184,2.184,0,0,0-2.552-.483,3.168,3.168,0,0,0-1.173-1.049,2.8,2.8,0,1,0-2.971,0,3.2,3.2,0,0,0-1.713,2.83l0,4h-1.2v-12.3l8-6,8,6Z" transform="translate(0 0)"/>
        </g>
      </g>
    </SVGBase>
  )
...
const Gear = props => {
  return (
    <SVGBase name="gear" {...props}>
      <g transform="translate(-873 -332)">
        <g transform="translate(2091.103 -4692.897) rotate(-90)">
          <g transform="translate(-5046 -1216)">
            <path d="M140.325,154.686A2.677,2.677,0,1,1,143,152.009,2.68,2.68,0,0,1,140.325,154.686Zm0-4.551a1.874,1.874,0,1,0,1.874,1.874A1.876,1.876,0,0,0,140.325,150.135Zm0,0" transform="translate(-130.782 -142.009)" />
            <path d="M10.929,20H8.157a1.445,1.445,0,0,1-1.4-1.126l-.351-1.56a7.66,7.66,0,0,1-1.628-.946l-1.519.48a1.444,1.444,0,0,1-1.687-.657L.19,13.8a1.457,1.457,0,0,1,.267-1.778l1.177-1.082A8.432,8.432,0,0,1,1.582,10a8.615,8.615,0,0,1,.052-.941L.463,7.982A1.455,1.455,0,0,1,.186,6.206l1.39-2.4a1.445,1.445,0,0,1,1.68-.652l1.522.481a7.668,7.668,0,0,1,1.628-.946l.352-1.562A1.444,1.444,0,0,1,8.157,0h2.772a1.445,1.445,0,0,1,1.4,1.126l.351,1.56a7.66,7.66,0,0,1,1.628.946l1.519-.48a1.446,1.446,0,0,1,1.687.658L18.9,6.2a1.457,1.457,0,0,1-.268,1.778L17.452,9.059a8.458,8.458,0,0,1,0,1.882l1.172,1.077.006.005a1.453,1.453,0,0,1,.272,1.771l-1.39,2.4a1.441,1.441,0,0,1-1.681.651l-1.522-.481a7.67,7.67,0,0,1-1.628.946l-.352,1.562A1.442,1.442,0,0,1,10.929,20ZM4.905,15.049a.625.625,0,0,1,.4.143A6.419,6.419,0,0,0,7.16,16.269a.625.625,0,0,1,.393.449L7.978,18.6a.187.187,0,0,0,.181.148H10.93a.186.186,0,0,0,.18-.147l.425-1.885a.625.625,0,0,1,.393-.449,6.431,6.431,0,0,0,1.857-1.078.623.623,0,0,1,.586-.114l1.834.579a.187.187,0,0,0,.221-.077l1.39-2.4a.2.2,0,0,0-.04-.241L16.37,11.642a.625.625,0,0,1-.2-.553,7.238,7.238,0,0,0,0-2.18.625.625,0,0,1,.2-.553l1.41-1.3a.2.2,0,0,0,.033-.245L16.431,4.426a.191.191,0,0,0-.227-.083l-1.832.578a.624.624,0,0,1-.586-.114,6.42,6.42,0,0,0-1.858-1.078.624.624,0,0,1-.393-.449L11.112,1.4a.191.191,0,0,0-.182-.147H8.157a.186.186,0,0,0-.18.147L7.552,3.282a.626.626,0,0,1-.393.449A6.413,6.413,0,0,0,5.3,4.808a.627.627,0,0,1-.586.114L2.882,4.343a.189.189,0,0,0-.221.077l-1.39,2.4a.2.2,0,0,0,.043.243L2.719,8.358a.625.625,0,0,1,.2.553,7.237,7.237,0,0,0,0,2.18.626.626,0,0,1-.2.553l-1.41,1.3a.2.2,0,0,0-.033.245l1.382,2.389a.192.192,0,0,0,.227.083l1.832-.578A.608.608,0,0,1,4.905,15.049Zm0,0" transform="translate(0)" />
          </g>
        </g>
      </g>
    </SVGBase>
...
const Logout = props => {
  return (
    <SVGBase name="logout" {...props}>
      <g transform="translate(-196 -329)">
        <g transform="translate(7356 1078)">
          <path d="M0 0H24V24H0z" fill="none" transform="translate(-7160 -749)"/>
          <path d="M0 0H20V20H0z" fill="none" transform="translate(-7158 -747)"/>
          <g id="logout" transform="translate(-7158 -747.008)">
            <path d="M285.873 209.258h-7.916a.625.625 0 0 1 0-1.25h7.916a.625.625 0 0 1 0 1.25zm0 0" transform="translate(-266.499 -199.875)"/>
            <path d="M400.629 135.471a.625.625 0 0 1-.442-1.067l2.683-2.683-2.683-2.683a.625.625 0 1 1 .884-.884l3.125 3.125a.625.625 0 0 1 0 .884l-3.125 3.125a.621.621 0 0 1-.442.183zm0 0" transform="translate(-384.379 -122.964)"/>
            <path d="M6.667 20.007a1.717 1.717 0 0 1-.517-.078l-5.015-1.67A1.682 1.682 0 0 1 0 16.674v-15A1.668 1.668 0 0 1 1.667.008a1.719 1.719 0 0 1 .517.078L7.2 1.756a1.682 1.682 0 0 1 1.133 1.585v15a1.668 1.668 0 0 1-1.666 1.666zm-5-18.749a.418.418 0 0 0-.417.417v15a.433.433 0 0 0 .289.4l4.991 1.663a.453.453 0 0 0 .136.018.418.418 0 0 0 .417-.417v-15a.433.433 0 0 0-.289-.4L1.8 1.276a.452.452 0 0 0-.133-.018zm0 0" />
            <path d="M38.334 6.674a.625.625 0 0 1-.625-.625V2.3a1.043 1.043 0 0 0-1.042-1.042h-9.374a.625.625 0 0 1 0-1.25h9.375A2.293 2.293 0 0 1 38.959 2.3v3.75a.625.625 0 0 1-.625.624zm0 0" transform="translate(-25.626)"/>
            <path d="M185.29 284.006h-3.333a.625.625 0 1 1 0-1.25h3.333a1.043 1.043 0 0 0 1.042-1.042v-3.75a.625.625 0 0 1 1.25 0v3.75a2.293 2.293 0 0 1-2.292 2.292zm0 0" transform="translate(-174.249 -266.499)"/>
          </g>
        </g>
      </g>
    </SVGBase>
...
const Users = props => {
  return (
    <SVGBase name="users" {...props}>
      <g transform="translate(-783 -332)">
        <g transform="translate(785 237.544)">
          <g transform="translate(7.152 102.376)">
            <path d="M185.937,149.6a2.848,2.848,0,1,0,2.848,2.848A2.851,2.851,0,0,0,185.937,149.6Zm0,4.43a1.582,1.582,0,1,1,1.582-1.582A1.584,1.584,0,0,1,185.937,154.033Z" transform="translate(-183.089 -149.603)" />
          </g>
          <g transform="translate(5.759 106.785)">
            <path d="M151.683,262.481a4.245,4.245,0,0,0-4.24,4.241v.949a.633.633,0,0,0,1.266,0v-.949a2.975,2.975,0,0,1,5.949,0v.949a.633.633,0,0,0,1.266,0v-.949A4.245,4.245,0,0,0,151.683,262.481Z" transform="translate(-147.443 -262.481)" />
          </g>
          <g transform="translate(12.911 100.456)">
            <path d="M333.38,100.456a2.848,2.848,0,1,0,2.848,2.848A2.851,2.851,0,0,0,333.38,100.456Zm0,4.43a1.582,1.582,0,1,1,1.582-1.582A1.584,1.584,0,0,1,333.38,104.886Z" transform="translate(-330.532 -100.456)" />
          </g>
          <g transform="translate(11.624 104.865)">
            <path d="M301.722,213.333a4.249,4.249,0,0,0-4.115,3.2.633.633,0,0,0,1.226.315,2.978,2.978,0,0,1,5.864.729v.949a.633.633,0,1,0,1.266,0v-.949A4.245,4.245,0,0,0,301.722,213.333Z" transform="translate(-297.587 -213.333)" />
          </g>
          <g transform="translate(1.392 100.456)">
            <g transform="translate(0 0)">
              <path d="M38.494,100.456a2.848,2.848,0,1,0,2.848,2.848A2.851,2.851,0,0,0,38.494,100.456Zm0,4.43a1.582,1.582,0,1,1,1.582-1.582A1.584,1.584,0,0,1,38.494,104.886Z" transform="translate(-35.646 -100.456)" />
            </g>
          </g>
          <g transform="translate(0 104.865)">
            <g transform="translate(0 0)">
              <path d="M8.335,216.51A4.235,4.235,0,0,0,0,217.574v.949a.633.633,0,0,0,1.266,0v-.949a2.969,2.969,0,0,1,5.843-.75.633.633,0,1,0,1.226-.315Z" transform="translate(0 -213.334)" />
            </g>
          </g>
        </g>
      </g>
