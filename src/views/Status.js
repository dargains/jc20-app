  ...
  return (
    <article className="mb-4">
      ...
      <div className="overflow-hidden w-full rounded-xl">
        ...
        <div className="bg-green05 h-2 w-full rounded-xl absolute top-0 left-0 duration-300 transition-transform delay-300" style={{transform: `translateX(-${100 - barStatus}%)`}} />
      </div>
    </article>
  )
}
